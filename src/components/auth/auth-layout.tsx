...
function LeftPanel() {
  return (
    <section
      ...
      className="relative hidden flex-col items-center justify-center overflow-hidden bg-card lg:flex lg:w-1/2"
      style={{
        backgroundImage:
      ...
      <div className="relative z-10 flex flex-col items-center gap-6 px-12 text-center">
        ...
        <div className="flex flex-col gap-2">
          {FEATURE_PILLS.map((pill) => (
            <div
              key={pill}
              className="rounded-full border px-4 py-2 text-[13px] font-medium text-accent"
              style={{
...
function FloatingCard({ card, index }: { card: CardData; index: number }) {
  return (
    ...
    >
      ...
      <div
        className="mt-2 inline-flex items-center rounded-full px-2 py-0.5 text-[11px] font-medium text-accent"
