    ...
    >
      {digits.map((d, i) => (
        <input
          ...
          className={cn(
            "h-12 w-10 rounded-xl border bg-white text-center font-mono text-xl font-semibold tabular-nums text-slate-900 shadow-sm transition sm:h-14 sm:w-12 sm:text-2xl",
